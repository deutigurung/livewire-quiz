                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form wire:submit.prevent="submitFormData">
                        <div>
                            ...
                            <x-textarea wire:model.defer="question.question_text" id="question_text" class="block mt-1 w-full" type="text" name="question_text" />
                            <x-input-error :messages="$errors->get('question.question_text')" class="mt-2"/>
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            @foreach($questionOptions as $index => $questionOption)
                                <div class="flex mt-2">
                                    <x-text-input wire:model.defer="questionOptions.{{ $index}}.option" type="text" class="w-full" name="questions_options_{{ $index }}" id="questions_options_{{ $index }}" autocomplete="off"/>
                         
                                    <div class="flex items-center">
                                        <input wire:model.defer="questionOptions.{{ $index}}.correct" type="checkbox" class="mr-1 ml-4"> Correct

                                         <!-- removeQuestionsOption of QuestionForm triggered when delete btn clicked -->
                            ...
                            <!-- addQuestionsOption of QuestionForm triggered when add btn clicked -->
